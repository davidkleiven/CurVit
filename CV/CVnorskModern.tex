...
\section{Utdanning}
\cvitem{2011 - Present}{Sivilinginør i Fysikk og Matematikk ved NTNU (Norges Teknisk Naturvitenskapelige Universitet)}
\cvitem{2010 - 2011}{Førstegangstjeneste i HM Kongens Grardes Musikk og drill kompani.}
\cvitem{2007 - 2010}{Studiespesialisering ved Skeisvang vgs.}

\section{Arbeidserfaring}
\cventry{2015 - 2016}{Teknisk student ved CERN}{}{}{}{
Jobbet på prosjekt hvor målet var å studere skade på komponenter i superledende magneter
...
gjennomføring av eksperimenter på kritiske komponenter av de superledende
magnetene i LHC.
}
...
Veileding en gruppe på ca. 20 studenter under regneøvinger.
}

\section{Tekniske ferdigheter}
\cvitem{Programmering}{C/C++, Fortran, MATLAB, Python, Perl}
...
\renewcommand{\refname}{Konferanseartikler}
