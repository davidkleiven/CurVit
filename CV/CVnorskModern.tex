...
\cventry{2021 - 2026}{Programvareutvikler i Statnett}{}{}{}{
	I Statnett jobbet på ulike prosjekter innen programvare utvikling.\projsep
	...
	Oppgaver bestod hovedsakelig av å utvikle analysemodulen i \emph{Monster} for datavisualisering, samt og vedlikeholde bayesianske justeringer av sannsynlighetsfordelinger basert på innkommende feilhendelser. \projsep
	...
	Systemet håndterer flaskehalser i strømnettet automatisk gjennom å blokkere bud som med all sannsynlighet vil føre til overlaster, samt å
	gjøre proaktiv systemregulering for å forhindre overlaster.\projsep
	I Abot jobbet jeg med å utvikle optimeringsalgoritmen for optimal lastflyt samt å bygge netttopologi fra data beskrevet innen Common Information Model (CIM) rammeverket.
	...
	\textbf{GridLens} -- Statnett har kjørte et utredningsarbeid med mål om å utredemuligheten for å utnytte informasjonen i CIM modeller mer direkte som databerikingskilde for å strømmende tidsserier.
